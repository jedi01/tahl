...
<script>
    ...
    function geTableData() {
        Table = $('.serverSide-table').DataTable({
            'aoColumns': [{mData: "traderID"}, {mData: "clientName"}, {mData: "accountName"}, {mData: "commission"}, {mData: "actions", bSortable: false}],
            ...
            'bServerSide': true,
            'sAjaxSource': '<?= settings_url("getClientsListTable") ?>',
