...
<form class="form" novalidate action="<?= user_url("profile") ?>" method="post">
        ...
        <div class="row">
            <div class="col-md-6">
                <fieldset class="form-group">
                    ...
                    <input type="text" id="userinput4" class="form-control border-primary" readonly placeholder="Position" name="position" value="<?= $currentUser->position ?>">
    ...
    <div class="form-actions right">
        <a type="button" class="btn btn-warning mr-1" href="<?= dashboard_url() ?>">
