        ...
        <div class="row">
                <div class="col-md-2">
                    <fieldset class="form-group">
                        ...
                        placeholder="Side" name="trade_val[0][Side]">
                        <option>Buy</option>
                        <option>Sell</option>
                ...
                <div class="col-md-2">
                    <fieldset class="form-group">
                        ...
                        <input class="form-control shares_0"  id="Shares" style="width: 100%;"  type="text" value="0" 
                ...
                <div class="col-md-2" id="symbol-holder">
                    <fieldset class="form-group">
                        ...
                        <input class="form-control symbol_0"  style="width: 100%;"  
                        placeholder="Symbol" name="trade_val[0][Symbol]">                        
                        <p class="help-block error_symbol_0 m-0 danger"></p>
                    </fieldset>
                </div>
                <div class="col-md-2">
                    <fieldset class="form-group">
                        <label for="AveragePrice">Average Price</label>
                        <input class="form-control averageprice_0"  style="width: 100%;"  type="text" value="0.00"
                        placeholder="Average Price" name="trade_val[0][AveragePrice]">                        
                        <p class="help-block error_avg_0 m-0 danger"></p>
                    </fieldset>
                </div>
                <div class="col-md-2">
                    <fieldset class="form-group">
                        <label for="SoftDollars">Soft Dollars</label>
                        <input class="form-control SoftDollars"  onkeyup="SoftDol(this);" id="SoftDollars" style="width: 100%;" value="0"
                        pattern="^(?=.*[0-9])\d*$"
                        ...
                        <p class="m-0 danger softDollHelp">    
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <fieldset class="form-group">
                        ...
                        <p class="m-0 danger softDollHelp" id="">    
                            Soft Dollars can't be greater than Total Commission
                        </p>
                    </fieldset>
                </div>
...
<script>
    ...
    function SoftDol(ele)
    {
      ...
      var softDoll = parseFloat($(ele).val().toString().replace(",", ""));
     var totalComm = parseFloat($("#TotalCommission").val().toString().replace(",", ""));

            if (softDoll > totalComm) {

            $(ele).find(".softDollHelp").show();
            } else {
            $(ele).find(".softDollHelp").hide();
            }
    ...
    } else {     $("#NetCommission").val("");
}
chgTotalComm();

console.log(softDoll+" "+totalComm);
