                ...
                <div class="card border-grey border-lighten-3 m-0">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal form-simple" action="<?= login_url() ?>" novalidate method="post">
                    ...
                    <div class="card-footer">
                        <div class="">
                            <p class="float-sm-left text-center m-0"><a href="<?= recover_url() ?>" class="card-link" style="color: #981B1E;">Recover password</a></p>
