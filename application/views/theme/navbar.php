            ...
            <div class="navbar-container content">
                <div class="navbar-expand" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                         <?php
                        if ($_SESSION["user"]->position === USER_ADMIN_EDITOR || $_SESSION["user"]->position === USER_TMT_SUBSCRIPTION ) {
                            ?>
                        <li class="dropdown  nav-item">
                            ...
                            <div class="dropdown-menu">
                                <?php if($_SESSION["user"]->position === USER_ADMIN_EDITOR){ ?>
                                <a class="dropdown-item" href="<?= dashboard_url("tradeList") ?>">Trade List</a>
                                <?php } ?>

                                <?php if($_SESSION["user"]->position === USER_TMT_SUBSCRIPTION || $_SESSION["user"]->position === USER_ADMIN_EDITOR){ ?>
                                <a class="dropdown-item" href="<?= dashboard_url("tmtSubscriptionList") ?>">TMT Subscription List</a>
                                <?php } ?>
                        ...
                        if ($_SESSION["user"]->position === USER_ADMIN_EDITOR || $_SESSION["user"]->position === USER_TMT_SUBSCRIPTION ) {
                            ...
                            <li class="dropdown nav-item">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="<?= settings_url("alertsList") ?>">Alerts and Reports</a>
                                    <?php } if($_SESSION["user"]->position === USER_TMT_SUBSCRIPTION || $_SESSION["user"]->position === USER_ADMIN_EDITOR){ ?>
                                    <a class="dropdown-item" href="<?= dashboard_url("TmtSubscription") ?>">Add TMT Subscription</a>
                                    <a class="dropdown-item" href="<?= dashboard_url("AccountCoverageList") ?>">TMT Account and Coverage List</a>
                                <?php } ?>
                                </div>
                            </li>    
                        <?php }
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <?php
                             if ($_SESSION["user"]->position == USER_TRADER) { ?>
                                <a class="dropdown-item" href="<?= dashboard_url("viewClients") ?>" id="profile_nav"><i class="ft-user"></i> View Client </a>
        
                                <a class="dropdown-item" href="<?= dashboard_url("addTrade") ?>" id="profile_nav"><i class="ft-user"></i> Add Trade </a>

                                <a class="dropdown-item" href="<?= dashboard_url() ?>" id="profile_nav"><i class="ft-user"></i> View Trade </a>
